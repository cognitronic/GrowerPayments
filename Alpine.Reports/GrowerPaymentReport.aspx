<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrowerPaymentReport.aspx.cs" Inherits="Alpine.Reports.GrowerPaymentReport1" %>
...
<body>
    ...
    <div>
        <b style="font-family:'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', 'DejaVu Sans Condensed', sans-serif;">Crop Year</b>
        <asp:DropDownList
        runat="server"
        AutoPostBack="true"
        OnSelectedIndexChanged="CropYearChanged"
        ID="ddlCropYear">
        </asp:DropDownList>&nbsp;&nbsp;&nbsp;
